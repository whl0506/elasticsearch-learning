...
```
 ...
 https://download.elastic.co/demos/kibana/gettingstarted/accounts.zip  ，解压导入测试数据，
...
https://github.com/medcl/elasticsearch-analysis-ik/releases 选择对应es版本安装
...
```shell
echo "樱桃萨其马，带你甜蜜入夏" > /mydata/nginx/html/es/fenci.txt 
```
...
```java
    ...
    public void searchData() throws IOException {
        GetRequest getRequest = new GetRequest( index:"users",id:"_-2vAHIB0nzmLJLkxKWk");
